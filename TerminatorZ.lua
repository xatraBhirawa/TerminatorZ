...
function SUE() 
AIM = gg.multiChoice({
	"📛Aimbot Extreme📛(Lobby)",
	"♈Aimbot Head♈[Lobby/Land]",
	"🔰Aimbot Ultra🔰",
	"⚜Aimbot Medium⚜(Lobby/Land)",
	"💯MicroAim💯(Lobby/Land)",
	"🔰MagicBullet v1[Land/Lobby]",
	"🔃Magic Bullet v2[Lobby]",
	"▶♉Headshot 80%[Land/Lobby]",
	"🔝Aimlock(Land)",
	"⚜Damage Increase⚜(Land)",
	"🆕Headshoot 70%(Mix Hs 80%)",
	"🛡Magic Bullet+Headshot 50%🛡(Test)",
 "🔫Headshot Test🔫(Test 0.8)",
 "🚩Magic Bullet V3🚩(Lobby)",
 "🚷MagicArticle🚯(Test)",
	"↩ Back"},
nil,"🔨 Menu SUE [AIM]\n🔏 Script by TerminatorZ")
...
gg.getResults(100)
gg.editAll('0.000002', gg.TYPE_FLOAT)
...
function EXIT()
IBR9 = print("Script: TerminatorZ 2.0 [TRZ V 2.0] ||XatraBirawa||")
...
print("▶Changelog V2 - Tunned Headshot For Better Play ")
os.exit()
end
